...
2. It installs dependencies, builds the Docusaurus site, and uploads the output as a Pages artifact
3. GitHub Pages deploys the artifact directly — no extra branch needed
...
3. That's it — no branch to configure
